...
public class KmbRouteEtaAdapter extends RouteEtaAdapter {
    ...
    public KmbRouteEtaAdapter(List<ETA> etas, List<RouteStop> routeStops, List<Stop> stopList, String timeDisplayStyle) {
        this.etas = etas;
